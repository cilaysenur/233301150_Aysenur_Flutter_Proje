              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    _buildTextField(hint: 'Örn: Ayşe Yılmaz', icon: Icons.person_outline),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () { print('Kayıt olunuyor...'); },
                        child: const Text('KAYIT OL', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
                      ),
                    ),
                  ],
                ),
